  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _cnpjCtrl.text = perfil['cnpj'] ?? '';
        _razaoCtrl.text = perfil['razao_social'] ?? '';
        _loading = false;
      });
          ...
          Container(
            ...
            child: Row(children: [
              Expanded(child: Row(children: [
                const Icon(Icons.business, size: 32, color: Color(0xFF4CE0D2)),
                const SizedBox(width: 12),
                const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Perfil da Empresa', style: TextStyle(
                    fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF4CE0D2),
                  )),
                  Text('Gerencie suas informações', style: TextStyle(
                          ...
                          child: Column(children: [
                            Container(
                              ...
                              child: Column(children: [
                                const CircleAvatar(
                                  radius: 50,
                                  backgroundColor: Color(0xFF4CE0D2),
                                  child: Icon(Icons.business, size: 40, color: Color(0xFF0A1929)),
                                ),
                            ...
                            Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                const Text('Informações Empresariais', style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF4CE0D2),
                                )),
                                const SizedBox(height: 20),
                                _buildField(_nomeCtrl, 'Nome da Empresa', Icons.business,
                                    validator: (v) => v!.isEmpty ? 'Informe o nome' : null),
                                const SizedBox(height: 15),
                                _buildField(_cnpjCtrl, 'CNPJ', Icons.badge),
                                const SizedBox(height: 15),
                                _buildField(_razaoCtrl, 'Razão Social', Icons.store),
                                const SizedBox(height: 15),
